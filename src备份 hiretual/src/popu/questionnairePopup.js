                ...
                obj1.map((name) => name.id == surveyid ?
                    <div id="survy" key={name.id }>
                        <button className="close-btn" onClick={closesurvey}>
                            <img src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/12/Vector-1.png"
                                alt="Cross icon in blue" />
                        </button>
                        <div>
                            <div className="title">
                                <img src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/12/Group-7109.png"
                                    alt="Checklist icon" />
