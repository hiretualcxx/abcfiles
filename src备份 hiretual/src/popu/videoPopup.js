...
const VideoPopup = (props) => {
  ...
  const videoJsOptions = { // lookup the options in the docs for more options
    ...
    fluid: true,
    sources: [{
      src: 'https://hiretual.com/wp-content/uploads/2021/12/new_video.mp4',
      type: 'video/mp4'
    }]
  }
  ...
  return (
    <Modal isOpen={nestedModal} className="videott">
      ...
      <div className="part6">
        ...
        <h2 className="part-title xuxu active">How Does Hiretual Work?</h2>
        <div className="box xuxu active">
          ...
          <button onClick={startPlay} style={ { display: videostate ?'block': 'none' } } className="control1">
            <img alt="Play video icon"   src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/11/videoplay.png" />
          </button>
          <button style={ { display:playstate ?videostate? "none": "block":"none" } } className="black-player" onClick={blackPlay} >
            <img alt="Play logo in black"  src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/11/black-player.svg" />
          </button>
          <div style={{display:videostate ?'block': 'none'}}>
            <div className="advantage advantage1">
              <img alt="Portrait of a happy man"  src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/11/peo1.png" />
            ...
            <div className="advantage advantage2">
              <img alt="Portrait of a man"   src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/11/peo2.png" />
            ...
            <div className="advantage advantage3">
              <img alt="Portrait of a woman"  src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/11/peo3.png" />
            ...
            <div className="advantage advantage4">
              <img alt="Portrait of a girl"  className=" ls-is-cached " src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/11/newHealthcare-2X.png" />
              <div className="text">Powerful<br /> integrations with your favorite tools</div>
              <div className="text2">Hiretual is the top AI sourcing vendor in the world</div>
            </div>
          </div>
          
        </div>
        <div className="surveydiv">
          <img src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/12/👆.png" alt="" />
          <p>
            TAKE OUR <a onClick={openMaskLayer}> 2-MINS SURVEY,</a></p><p>
            AND FIND OUT WHICH PLAN IS  <a onClick={openMaskLayer} > BEST FOR YOUR NEEDS  <img src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2021/12/Arrow-26.png" alt="" /></a>
          </p>
        </div>
