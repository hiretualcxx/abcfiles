...
function Boolean() {
  ...
  const ajax_fn = (d, callback, type,skillstype) => {
    ...
    if(window.location.host == 'hiretual.com'){
      ...
      <div className="boolean_part">
        <div className="main">
          <div className="toptitle">
            <img src="https://hiretual.com/wp-content/uploads/2021/12/Active.png" alt="Boolean icon"
              className="icon" />
            <h1 className="ph1">
          ...
          <div className="formbox">
            ...
            <div className="job_box outbox">
              ...
              <div className="titlebox">
                ...
                <Restbutton category="hiretual Boolean Builder" control="skill" onClick={rest} />
            ...
            <a href="javascript:void(0)" data-vars-ga-category="hiretual Boolean Builder" data-vars-ga-action="click_generate boolean" data-vars-ga-label={pageurl} onClick={generateboolean} className={`but ${butstate}`}>
                Generate Boolean
            </a>
