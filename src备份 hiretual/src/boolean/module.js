...
function Waringtext(params){
    return( params.visible ? 
        <div className="waring"><img className="icon" src="https://staging-hiretual.kinsta.cloud/wp-content/uploads/2022/01/waring.png" alt="" /> You have exceeded the maximum number of words (32)</div> : ''
    )
}
